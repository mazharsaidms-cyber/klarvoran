...
export function InstitutionDownload({ kind }: { kind: InstitutionalDownloadKind }) {
  ...
  return (
    <div className="download-card rounded-[var(--radius-md)] border border-navy-100 bg-white p-5 shadow-card sm:p-6">
      ...
      >
        <svg className="shrink-0" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
